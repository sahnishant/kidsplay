<script lang="ts">
  ...
  function startSession(entryId: string): void {
    try {
      ...
      enterSessionBackBoundary(); activeSession = launch; activeEntryId = entryId;
  ...
  function startStoryMission(missionId: string): void {
    try {
      ...
      enterSessionBackBoundary(); activeSession = launch.session; activeStoryMission = launch.mission;
  ...
  function resumeMock(): void {
    ...
    try {
      ...
      enterSessionBackBoundary(); activeSession = { ...launch, questions }; activeEntryId = resumableMock.entryId;
  ...
  function handleCheckpoint(state: SessionState): void {
    ...
    resumableMock = saveMockCheckpoint({
      entryId: activeEntryId, title: activeSession.title,
