...
<style>
  ...
  @media(max-width:760px){.grove-depth{height:auto;min-height:calc(100dvh - 42px);overflow:visible}.grove-layout{grid-template-columns:1fr;overflow:visible}.grove-scene{min-height:440px}.work-panel{min-height:220px}.scientu{width:72px;height:72px}.dheu{width:68px;height:68px}.scene-instruction{left:74px;right:74px}.shelter{left:34%;transform:scale(.86)}.roof-slot{left:calc(34% + 34px)}.perch-slot{left:calc(34% + 42px)}.feeder,.feed-drop,.feeder-slot{left:66%}.compost{left:58%}.compost-slot{left:55%}.meadow-patch--1,.water-target--1{left:8%}.meadow-patch--2,.water-target--2{left:35%}.meadow-patch--3,.water-target--3{left:61%}.watering-can{left:4%;top:50%}.loose-roof{left:5%}.loose-perch{left:17%}.scatter-item--1{left:6%}.scatter-item--2{left:27%}.scatter-item--3{left:47%}}
  @media(max-width:420px){.grove-hud{grid-template-columns:44px 1fr 58px}.grove-hud small{display:none}.grove-hud h1{font-size:.88rem}.grove-scene{min-height:390px}.scene-instruction{left:55px;right:55px;padding:6px 8px}.scene-instruction span{font-size:.56rem}.scientu{top:16%;left:0;width:62px;height:62px}.dheu{top:22%;right:0;width:58px;height:58px}.shelter{left:28%;top:37%;transform:scale(.72)}.roof-slot{left:calc(28% + 28px);top:34%;transform:scale(.82)}.perch-slot{left:calc(28% + 38px);top:49%;transform:scale(.82)}.feeder,.feed-drop,.feeder-slot{left:63%;transform:scale(.82)}.roof-slot,.perch-slot,.feeder-slot{min-height:54px}.compost{left:48%}.compost-slot{left:44%}.loose-piece,.scatter-item,.seed-scoop,.watering-can{transform:scale(.82)}.loose-roof{left:2%}.loose-perch{left:14%}.scatter-item--1{left:1%;top:49%}.scatter-item--2{left:23%;top:61%}.scatter-item--3{left:45%;top:66%}.meadow-patch,.water-target{width:95px}.meadow-patch--1,.water-target--1{left:2%}.meadow-patch--2,.water-target--2{left:34%}.meadow-patch--3,.water-target--3{left:66%}.watering-can{left:1%;top:49%}.no-fake-button small{font-size:.53rem}}
