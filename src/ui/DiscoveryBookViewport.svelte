...
<style>
  .discovery-book{width:min(900px,100%);height:calc(100dvh - 42px);margin:auto;display:grid;grid-template-rows:auto auto minmax(0,1fr);gap:8px;overflow:hidden;color:var(--ink)}
