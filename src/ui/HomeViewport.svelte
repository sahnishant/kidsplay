<script lang="ts">
  ...
  type HomeView = ChildPrimaryView | GrownUpView | 'player' | 'phonics';
...
<style>
  ...
  .home-viewport__stage,.home-panel-screen,.home-panel-body{min-height:0}.home-viewport__stage,.home-panel-screen{overflow:hidden}.home-panel-screen{grid-row:1/-1;display:flex;flex-direction:column;gap:7px}.phonics-host{grid-row:1/-1;min-height:0;overflow:hidden}
