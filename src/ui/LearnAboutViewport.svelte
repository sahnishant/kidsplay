...
<style>
  .learn-about{width:min(760px,100%);height:calc(100dvh - 42px);margin:auto;display:flex;flex-direction:column;gap:6px;overflow:hidden}.learn-about button{min-height:46px;border:0;border-radius:12px;font:inherit;font-weight:850;cursor:pointer}.topbar{display:grid;grid-template-columns:46px 1fr auto;align-items:center;gap:8px;padding:5px;border:1px solid #24303a17;border-radius:15px;background:#fff}.back{width:46px;background:var(--accent-soft);color:var(--accent);font-size:1.2rem}.topbar small,.label{color:var(--accent);font-size:.58rem;font-weight:950;letter-spacing:.06em}.topbar h1,.section h2{margin:0}.topbar h1{font-size:1.08rem}.icon{font-size:1.7rem}.topics,.scroll{min-height:0;overflow:auto}.topics{flex:1;display:grid;grid-template-columns:repeat(3,1fr);gap:8px;align-content:start}.topic{min-height:140px;display:grid;place-items:center;padding:10px;background:#fff;border:1px solid #24303a1c!important}.topic>span{font-size:3rem}.topic small{color:var(--muted)}.depths{display:grid;grid-template-columns:repeat(4,1fr);gap:5px}.depths button{font-size:.64rem;background:#fff;border:1px solid #24303a20}.depths .active{background:var(--accent-soft);color:var(--accent);border-color:var(--accent)}.scroll{flex:1}.section{margin-bottom:8px;padding:9px;border-radius:15px;background:#fff;border:1px solid #24303a14}.section h2{font-size:.94rem}.card{margin-top:7px;padding:8px;border-radius:12px;background:#f7f9fb}.card p{margin:4px 0;font-size:.77rem;line-height:1.35}.label{display:block;margin-bottom:4px}.rows{display:flex;flex-wrap:wrap;gap:6px}.rows button,.rows span,.card>button{padding:6px 9px;background:#fff}.rows span{border-radius:10px;font-size:.72rem}.wide{width:100%}.wide>span{font-size:1.5rem}.action{margin-top:5px!important;background:var(--accent)!important;color:#fff}.reveal{padding:6px;border-radius:9px;background:#fff}.loading{padding:18px;text-align:center}button:focus-visible{outline:3px solid #1b6dff;outline-offset:2px}@media(max-width:520px){.topics{grid-template-columns:1fr}.topic{min-height:105px;grid-template-columns:auto 1fr;justify-items:start}.topic>span{grid-row:1/3}.depths button{font-size:.58rem}}@media(prefers-reduced-motion:reduce){*{animation:none!important;transition:none!important}}
</style>
