...
<style>
  ...
  @media(max-width:650px){.workshop__steps{overflow-x:auto;grid-template-columns:repeat(7,minmax(52px,1fr))}.workshop__step{grid-template-columns:1fr;gap:1px}.workshop__lesson{grid-template-columns:1fr;grid-template-rows:auto auto auto auto auto;padding:8px}.workshop__lesson-heading,.workshop__look,.workshop__try{grid-column:1}.workshop__visual{min-height:155px;max-height:27dvh}.workshop__visual--mechanism{min-height:330px;max-height:none}}
</style>
