...
<style>
  ...
  .challenge-hero button{min-height:42px;margin-top:8px;padding:7px 16px;border:0;border-radius:13px;background:var(--accent);color:#fff;font:inherit;font-weight:950;cursor:pointer}
