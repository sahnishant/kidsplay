...
<style>
  .home-nav-menu{position:absolute;right:8px;bottom:8px;z-index:70}
  .home-nav-menu__toggle{min-width:48px;min-height:44px;display:flex;align-items:center;justify-content:center;gap:5px;padding:6px 9px;border:1px solid #24303a1f;border-radius:14px;background:#fffffff2;color:var(--ink);box-shadow:0 7px 20px #24303a1f;cursor:pointer;list-style:none;-webkit-tap-highlight-color:transparent}
  .home-nav-menu__toggle::-webkit-details-marker{display:none}
  .home-nav-menu__toggle span{font-size:1.05rem;line-height:1}
  .home-nav-menu__toggle small{font-size:.63rem;font-weight:900}
  .home-nav{position:absolute;right:0;bottom:51px;width:148px;display:grid;grid-template-columns:1fr;gap:5px;padding:6px;border:1px solid #24303a1a;border-radius:16px;background:#fffffff7;box-shadow:0 12px 28px #24303a24}
