...
<style>
  ...
  .mechanism__trace{min-height:27px;display:flex;align-items:center;gap:4px;overflow-x:auto;padding-bottom:1px}.mechanism__trace span{flex:0 0 auto;padding:5px 7px;border-radius:999px;background:#eef1f3;color:#5a6872;font-size:.58rem;font-weight:900}.mechanism__trace .mechanism__trace--current{background:#f3f0ff;color:#3f36a8;border:1px solid #6358dc33}.mechanism__trace b{font-size:.68rem;color:#909ba3}.mechanism__action{min-height:40px;border:0;border-radius:11px;background:var(--accent);color:#fff;font:inherit;font-size:.76rem;font-weight:900;cursor:pointer}
